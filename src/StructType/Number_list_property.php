...
/**
 * This class stands for number-list-property StructType
 * @subpackage Structs
 */
class Number_list_property extends Property
{
    /**
     * The integer
     * @var int
    ...
    public $double;
    /**
     * Constructor method for number-list-property
     * @uses Number_list_property::setInteger()
     * @uses Number_list_property::setLong()
     * @uses Number_list_property::setFloat()
     * @uses Number_list_property::setDouble()
     * @param int $integer
     * @param int $long
     * @param float $float
     * @param float $double
     ...
     * Set integer value
     * @param int $integer
     * @return \InfoCert\Top\OnboardingService\StructType\Number_list_property
     */
