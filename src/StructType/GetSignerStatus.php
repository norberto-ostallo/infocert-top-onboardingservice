...
/**
 * This class stands for getSignerStatus StructType
 * Meta informations extracted from the WSDL
 * - type: tns:getSignerStatus
 * @subpackage Structs
 */
class GetSignerStatus extends AbstractStructBase
{
    /**
     * The company_id
     * Meta informations extracted from the WSDL
    ...
    public $signer_id;
    /**
     * Constructor method for getSignerStatus
     * @uses GetSignerStatus::setCompany_id()
     * @uses GetSignerStatus::setDossier_id()
     * @uses GetSignerStatus::setSigner_id()
     ...
     * @param string $company_id
     * @return \InfoCert\Top\OnboardingService\StructType\GetSignerStatus
     */
