...
/**
 * This class stands for getDossier StructType
 * Meta informations extracted from the WSDL
 * - type: tns:getDossier
 * @subpackage Structs
 */
class GetDossier extends AbstractStructBase
{
    /**
     * The company_id
     * Meta informations extracted from the WSDL
    ...
    public $dossier_id;
    /**
     * Constructor method for getDossier
     * @uses GetDossier::setCompany_id()
     * @uses GetDossier::setDossier_id()
     ...
     * @param string $company_id
     * @return \InfoCert\Top\OnboardingService\StructType\GetDossier
     */
