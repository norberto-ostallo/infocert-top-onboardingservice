...
/**
 * This class stands for claimer StructType
 * @subpackage Structs
 */
class Claimer extends Legal_id
{
    /**
     * The first_name
    ...
    public $last_name;
    /**
     * Constructor method for claimer
     * @uses Claimer::setFirst_name()
     * @uses Claimer::setLast_name()
     ...
     * @param string $first_name
     * @return \InfoCert\Top\OnboardingService\StructType\Claimer
     */
