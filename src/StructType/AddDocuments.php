...
/**
 * This class stands for addDocuments StructType
 * Meta informations extracted from the WSDL
 * - type: tns:addDocuments
 * @subpackage Structs
 */
class AddDocuments extends AbstractStructBase
{
    /**
     * The company_id
     * Meta informations extracted from the WSDL
    ...
    public $documents;
    /**
     * Constructor method for addDocuments
     * @uses AddDocuments::setCompany_id()
     * @uses AddDocuments::setDossier_id()
     * @uses AddDocuments::setDocuments()
     ...
     * @param string $company_id
     * @return \InfoCert\Top\OnboardingService\StructType\AddDocuments
     */
